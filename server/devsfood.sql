...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2023 at 02:18 AM
...
INSERT INTO `orderproducts` (`id`, `order_id`, `product_id`, `created_at`) VALUES
(1, 1, 1, '2023-02-12 00:54:44'),
(2, 1, 2, '2023-02-12 00:54:44');
...
INSERT INTO `orders` (`id`, `user_id`, `address_id`, `total`, `delivery_fee`, `status`, `created_at`) VALUES
(1, 4, 1, '124.31', '7.99', 'received', '2023-02-12 04:54:44');
...
(2, 'Renan Gustavo', 'renandevfullstack@gmail.com', '$2y$10$Ww6ntFV9QG9/4NXr6OG3XeVxkmWCRqbEai6a6.9pXuHSuluOiPi3i', '50463e396d69ded7b62b591a3dc227a1', '2023-02-12', '2022-12-30 23:22:59', '2023-02-05 10:13:59'),
